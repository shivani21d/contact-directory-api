...
var ContactController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard), (0, common_1.Controller)('contacts')];
    ...
    var ContactController = _classThis = /** @class */ (function () {
        ...
        ContactController_1.prototype.create = function (userId, dto) {
            return this.contactService.create(userId, dto);
        };
        ContactController_1.prototype.findAll = function (userId, query) {
            return this.contactService.findAll(userId, query);
        };
        ContactController_1.prototype.update = function (userId, id, dto) {
            return this.contactService.update(userId, id, dto);
        };
        ContactController_1.prototype.remove = function (userId, id) {
